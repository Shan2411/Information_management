...
if ($search) {
    ...
    $query .= " WHERE name LIKE '%$search_safe%' OR email LIKE '%$search_safe%'";
}
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    <i class="fas fa-envelope text-gray-400 mr-2"></i><?= htmlspecialchars($row['email']) ?>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="EditStaff.php?id=<?= $row['staff_id'] ?>" 
                                        class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition inline-flex items-center mr-2">
                                        <i class="fas fa-edit mr-2"></i>Edit
                                    </a>
                                    <a href="AdminStaff.php?delete=<?= $row['staff_id'] ?>" 
