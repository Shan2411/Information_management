...
<title>Staff Dashboard | Device Market</title>
...
<div class="flex h-screen">
    ...
    <aside class="w-64 bg-[rgb(116,142,159)] text-white flex flex-col shadow-xl">
        ...
        <nav class="flex-1 p-4 space-y-2">
            <a href="StaffDashboard.php" class="sidebar-link active flex items-center py-3 px-4 rounded-lg transition">
    ...
    <main class="flex-1 overflow-y-auto">
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <section class="bg-white shadow-lg rounded-xl p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="StaffOrders.php" class="text-sm text-[rgb(116,142,159)] hover:underline">View All</a>
                    </div>
                    <div class="space-y-3">
                ...
                <section class="bg-white shadow-lg rounded-xl p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="StaffProducts.php" class="text-sm text-red-600 hover:underline">Manage Stock</a>
                    </div>
                    <div class="space-y-3">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 text-right">
                                    ...
                                    <a href="StaffProducts.php?delete=<?= $row['product_id'] ?>" onclick="return confirm('Delete this product?')" class="text-red-600 hover:text-red-800"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
            ...
            <footer class="text-center text-gray-500 text-sm mt-8 pb-4">
                © <?= date('Y') ?> Device Market Staff Panel | All Rights Reserved
            </footer>
        </div>
    </main>
</div>
