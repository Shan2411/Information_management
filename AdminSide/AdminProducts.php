...
<head>
    ...
    <title>Manage Products | Device Market</title>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-6">
                <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
                    <form method="GET" class="flex-1 flex gap-3 w-full">
                        ...
                        <?php if ($search): ?>
                        <a href="AdminProducts.php" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2.5 rounded-lg transition">Clear</a>
                        <?php endif; ?>
                    </form>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-2 justify-center">
                                        ...
                                        <a href="AdminProducts.php?delete=<?= $product['product_id'] ?>" 
